...
import com.example.restoaslam.adapter.OrderAdapter;
import com.example.restoaslam.model.Order;
import com.example.restoaslam.model.OrderItem;
        ...
        bayarSekarangButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedId == -1) {
                    ...
                    Toast.makeText(DaftarPesanan.this, "Pilih metode pembayaran terlebih dahulu", Toast.LENGTH_SHORT).show();
                ...
                DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReferenceFromUrl("https://restoaslam-ecbd1-default-rtdb.firebaseio.com/");
                ...
                databaseReference.child("orders").push().setValue(order)
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                Toast.makeText(DaftarPesanan.this, "Pembayaran anda berhasil!", Toast.LENGTH_SHORT).show();

                                // Open the RiwayatPesananActivity
                                Intent riwayatIntent = new Intent(DaftarPesanan.this, RiwayatPesanan.class);
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                ...
                                Toast.makeText(DaftarPesanan.this, "Gagal menyimpan data pesanan", Toast.LENGTH_SHORT).show();
                            }
                        });
            }
        });
