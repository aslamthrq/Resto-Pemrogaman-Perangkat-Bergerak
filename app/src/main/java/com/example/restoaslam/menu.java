...
import com.example.restoaslam.adapter.FoodAdapter;
...
public class menu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        orderButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!hasSelectedItems) {
                    ...
                    Toast.makeText(menu.this, "Harus memilih makanan", Toast.LENGTH_SHORT).show();
                ...
                Intent orderIntent = new Intent(menu.this, DaftarPesanan.class);
        ...
        riwayatButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent mainIntent = new Intent(menu.this, RiwayatPesanan.class);
